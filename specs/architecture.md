# Arquitetura do Projeto: NeoClaw

**Versão:** 1.0  
**Status:** Definição Central de Arquitetura  
**Autor original:** Antigravity (IA)  
...
```mermaid
graph TB
    User([👤 Usuário neocles])
    Telegram[📱 Telegram Client]
    System[🏗️ NeoClaw Engine]
