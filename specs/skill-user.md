# Spec: Skill Management System (Hot-Reload) — NeoClaw
...
**Usuario Primario:** Neocles, através da pasta Filesystem para inserir diretórios customizados com `.md`, e o bot interno (Loader e Executor) para lidar nos backgrounds da arquitetura.
